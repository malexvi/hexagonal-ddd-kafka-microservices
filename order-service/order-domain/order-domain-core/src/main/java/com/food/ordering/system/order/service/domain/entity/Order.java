...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void approve(){
        if(orderStatus != OrderStatus.PAID){
            throw new  OrderDomainException("Order is not in approve state for approve operation");
        }
        orderStatus = OrderStatus.APPROVED;
    }

    public void innitCancel(List<String> failureMessages){
        if(orderStatus != OrderStatus.PAID){
            throw new  OrderDomainException("Order is not in approved state for cancel operation");
        }
